...
---`🔹 Server`<br>
---Sets the round
---@param iRound number @The new round
---
...
---`🔹 Server`<br>
---Ends the round
---@param iReason number @The reason for the round ending
---
function GM:EndRound(iReason)
    if (self:GetRound() ~= RoundType.Playing) then  return end
...
function GM:StartRound()
    ...
    if (#tPlayers < GM.Cfg.MinPlayers) then return end
